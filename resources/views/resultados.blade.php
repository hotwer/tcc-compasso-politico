...
<p>O cálculo do perfil ideológico é um trabalho em andamento, e é muito menos exato que os valores e eixos ideológicos acima.</p>
<p>Você pode enviar esses resultados copiando e colando a URL no topo da página ou usando a imagem abaixo. Acha que a ideologia associada está errada? Quer nos ajudar a calibrar os testes? Envie os resultados juntamente com sua ideologia política para nós no endereço eightvalues@gmail.com, ou nos mande quaisquer comentários, perguntas ou críticas.</p>
<hr/>
<img src="" id="banner">
...
<script>
    ...
    diplArray = ["Cosmopolita","Internacionalista","Pacifista","Balanceado","Patriótico","Nacionalista","Chauvinista"]
    govtArray = ["Anarquista","Libertário","Liberal","Moderado","Estadista","Autoritário","Totalitarista"]
    sctyArray = ["Revolucionário","Muito Progressista","Progressista","Neutro","Conservador","Muito Conservador","Reacionário"]
